...
import com.kaiku.composecomponent.extension.pocketShadow
 ...
 * @param shadowConfig shadow configuration of the popup
 ...
 */
@Composable
fun BasePopupComponent(
    popupState: PopupState,
    onDismissRequest: () -> Unit,
    modifier: Modifier = Modifier,
    offset: DpOffset = DpOffset(0.dp, 10.sdp()),
    shadowConfig: ShadowConfig = ShadowConfig().copy(corner = 8.sdp()),
 ...
 * @param shadowConfig [ShadowConfig] for this composable.
...
private fun PopupContent(
    ...
    Surface(
        modifier = Modifier
            ...
            .pocketShadow(config = shadowConfig),
...
//            if (isFitTop) toBottom else toTop,
        ...
        onPopupPositionFound(horizontalAndOffset.first, isFitBottom)
